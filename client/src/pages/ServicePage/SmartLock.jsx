...
import smartLockBanner from '../../assets/smartLockBanner.jpg'
...
const SmartLock = () => {
    ...
    const specificCategory = smartLock["smartLock"];
    ...
    const fetchAndCategorizeData = async () => {
        try {
            ...
            const groupedByCategory = data.reduce((acc, item) => {
                // Only process items with the category 'smartLock'
                if (item.category === "smartLock") {
            ...
            console.log("Grouped by 'smartLock' Category:", groupedByCategory);
            setSmartLock(groupedByCategory);
                    ...
                    <section className='py-16'>
                        <div className='grid grid-cols-2 gap-12'>
                            <div className='w-full '>
                                <img src={smartLockBanner} className='object-cover h-full w-full rounded-lg' alt="" />
                            </div>
                                ...
                                <div className='flex flex-col '>
                                    ...
                                    <div className='w-full flex flex-col gap-3'>
                                        ...
                                        <div className="flex flex-col gap-6">
                                            {Object.keys(smartLock).length === 0 ? (
                                                <p>Loading services...</p>
                                            ) : (
                                                Object.entries(smartLock).map(([category, services]) => (
                                                    <div key={category}>
