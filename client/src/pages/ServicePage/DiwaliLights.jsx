...
const DiwaliLights = () => {
    ...
    const specificCategory = diwaliLights["diwaliLights"];
    ...
    const fetchAndCategorizeData = async () => {
        try {
            ...
            const groupedByCategory = data.reduce((acc, item) => {
                // Only process items with the category 'diwaliLights'
                if (item.category === "diwaliLights") {
            ...
            console.log("Grouped by 'diwaliLights' Category:", groupedByCategory);
                                ...
                                <div className='flex flex-col '>
                                    ...
                                    <div className='w-full flex flex-col gap-3'>
                                        ...
                                        <div className="flex flex-col gap-6">
                                            {Object.keys(diwaliLights).length === 0 ? (
                                                <p>Loading services...</p>
                                            ) : (
                                                Object.entries(diwaliLights).map(([category, services]) => (
                                                    <div key={category}>
