...
import spaAyurvedaBanner from '../../assets/spaAyurvedaBanner.jpg'
...
const SpaAyurveda = () => {
    const [spaAyurveda, setSpaAyurveda] = useState([]);
    ...
    const specificCategory = spaAyurveda["spaAyurveda"];
    ...
    const fetchAndCategorizeData = async () => {
        try {
            ...
            const groupedByCategory = data.reduce((acc, item) => {
                // Only process items with the category 'spaAyurveda'
                if (item.category === "spaAyurveda") {
            ...
            console.log("Grouped by 'spaAyurveda' Category:", groupedByCategory);
            setSpaAyurveda(groupedByCategory);
                    ...
                    <section className='py-16'>
                        <div className='grid grid-cols-2 gap-12'>
                            <div className='w-full '>
                                <img src={spaAyurvedaBanner} className='object-cover h-full w-full rounded-lg' alt="" />
                            </div>
                                ...
                                <div className='flex flex-col '>
                                    ...
                                    <div className='w-full flex flex-col gap-3'>
                                        ...
                                        <div className="flex flex-col gap-6">
                                            {Object.keys(spaAyurveda).length === 0 ? (
                                                <p>Loading services...</p>
                                            ) : (
                                                Object.entries(spaAyurveda).map(([category, services]) => (
                                                    <div key={category}>
